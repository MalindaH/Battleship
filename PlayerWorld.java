...
public class PlayerWorld extends World
{
    ...
    private void addShips()
    {
        ...
        else
        {
            if( addedToGrid == false )
            {
                ...
                //Adds the ship at the default location because the code in Ship makes the Ship follow the mouse.
                addObject( toAdd, 0, 0 );
    ...
    /**
     * fillBoard fills the numeric representation of the gameboard with 1's
     * where a ship is located
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
    ...
    /**
     * displayBoard displays the numerical representation of the game board
     * where 1's indicate that a ship was placed at that location and 0's
